...
import com.duck.duckcore.gui.GUI;
import com.duck.duckcore.multiversion.MultiVersion;
import com.duck.duckcore.nms.NMS;
...
public class DuckCore extends JavaPlugin {
    ...
    private static DuckCore instance;

    /**
     * Constructor used for UnitTests
     */
    public DuckCore(JavaPluginLoader loader, PluginDescriptionFile description, File dataFolder, File file) {
    ...
    public void onDisable() {
        ...
        getLogger().info("");
        getLogger().info("");
        getLogger().info(getDescription().getName() + " foi desabilitado!");
        getLogger().info("");
        getLogger().info("");
    }
    ...
    public static DuckCore getInstance() {
        return instance;
    }
